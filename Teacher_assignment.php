...
if (isset($_SESSION["teacher"])) {
    ...
    $resultset = Database::search("SELECT * FROM `assignment_view` WHERE `email` = '" . $user["email"] . "' ORDER BY `id` DESC;");
                        ...
                        <div class="card">
                            ...
                            <h5 class="card-title mb-0 mt-2">Teacher | <?php echo $user["name"]; ?></h5>
                                ...
                                <button class="btn btn-info mt-4" type="button" data-bs-toggle="modal"
                                    data-bs-target="#staticBackdrop">Add New Assignment</button>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    ?>
                                                        <a class="btn w-100 btn-secondary" href="Assignment_submitted.php?id=<?php echo $result["id"]; ?>">To Answers</a></td>
                                                    <?php
                                                    }elseif($result["status_id"] > 3){
                                                    ?>
                                                        <a class="btn w-100 btn-danger" href="Assignment_submitted.php?id=<?php echo $result["id"]; ?>"><?php echo $result["status"] ?></a></td>
                                                    <?php
                                                    }else{
                                                    ?>
                                                        <label class="btn w-100 btn-info"><span><?php echo $result["status"] ?></span></label>
                                                    <?php
                                                        }
                                                    ?>
                                                </td>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="staticBackdropLabel">Add New Assignment</h5>
                ...
                <div class="modal-body">
                    <div class="row row-gap">
                        ...
                        <div class="col-12">
                            ...
                            <input id="assiname" class="form-control" type="text" />
                        </div>
                        <div class="col-12 col-lg-6">
                ...
                <div class="modal-footer">
                    ...
                    <button onclick="UploadAssignment();" type="button" class="btn btn-primary">Submit Assignment</button>
                </div>
            </div>
        </div>
    </div>
